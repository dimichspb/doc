...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        <div class="navbar-header">
            <?php if (Yii::$app->user->isGuest): ?>
            <?= Html::a('<span class="logo-lg"><img src="/favicon.ico" alt="' . Yii::$app->name . '" title="' . Yii::$app->name . '">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'navbar-brand']) ?>
            <?php else: ?>
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                */ ?>
                <li>
                    <?= Yii::$app->user->isGuest? Html::a('Войти', ['site/login']): '' ?>
                </li>
            </ul>
        </div>
    </nav>
